 ...
 *
 * @remarks
 * Target runtime is Cloudflare Computer (see `agent/lib/computer.ts`). Eve's current
 * hosted backend remains Vercel Sandbox until a Computer adapter lands. Running locally
 * still requires the project to be linked when this backend is Vercel.
 *
