# Zenmium i18n
This directory contains the translations for Zenmium browser UI strings.
...
batches][pr], if you would like to contribute to the translation of Zenmium,
...
- "Zenmium" and other brand names should not be translated
...
## Development
When adding strings to Zenmium, you might need to regenerate the source
